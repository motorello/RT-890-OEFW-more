...
ifeq ($(NOKIA_STARTUP_TONE),1)
	CFLAGS += -DNOKIA_STARTUP_TONE
endif
ifeq ($(ENABLE_AM_FIX),1)
...
ifeq ($(ENABLE_AM_FIX_INDEX_DISPLAY), 1)
	CFLAGS += -DENABLE_AM_FIX_INDEX_DISPLAY
endif
ifeq ($(ENABLE_FM_RADIO), 1)
...
ifeq ($(ENABLE_AUTO_SWITCH_AM), 1)
	CFLAGS += -DENABLE_AUTO_SWITCH_AM
endif
